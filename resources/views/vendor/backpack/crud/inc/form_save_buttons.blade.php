...
<div id="saveActions" class="form-group">
    ...
    <div class="btn-group" role="group">
        ...
        @if ( isset($entry) && $crud->getCurrentOperation() == "update" && $entry->getTable() == "orders" &&
            ( strtolower(backpack_user()->roles[0]->name) == "admin" || strtolower(backpack_user()->roles[0]->name) == "super admin" )
        )
        <button type="submit" id="receiveOrder" class="ml-2 btn btn-primary">
            <span class="la la-get-pocket" role="presentation" aria-hidden="true"></span> &nbsp;
            <span data-value="receive_order">Receive order</span>
        </button>
