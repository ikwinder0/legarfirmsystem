...
<div class="card" style="max-width: 800px">
    <table class="table tbl-loan">
        <tr>
            <td style="width: 130px"><strong>Purchaser : </strong></td>
    ...
    <table class="table sm:table-sm table-responsive-lg tbl-loan">
        ...
        <tr>
            <th scope="col" class="text-right" class="text-right">Subtotal :</th>
            <th scope="col" class="text-right">{{ number_format($entry->subtotal(),2) }}</th>
            <th scope="col" class="text-right">0.00</th>
            <th scope="col" class="text-right"></th>
        </tr>
        <tr>
            <th scope="col" class="text-right" colspan="3" class="text-right">Total Amount Payable Including GST (MYR) :
            </th>
            <th scope="col" class="text-right">{{ number_format($entry->subtotal(),2) }}</th>
        </tr>
        {{-- --------------------------------------------------- --}}
