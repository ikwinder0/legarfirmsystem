...
<div class="card" style="max-width: 800px">
    <table class="table tbl-cost-of-assist-vendor">
        <tr>
            <td style="max-width: 150px"><strong>Vendor : </strong></td>
    ...
    <table class="table sm:table-sm table-responsive-lg tbl-cost-of-assist-vendor">
        ...
        <tr>
            <td colspan="4">
                Pursuant to Section 5 of the Solicitor’s Remuneration Order 2005 we shall be entitled to charge interest
                at 8% perannum from the expiration of one (1) month from the date of this Bill.
            </td>
        </tr>
        {{-- --------------------------------------------------- --}}
    </table>
