...
class CheckIfAdmin
{
     ...
     */
    private function checkAuthUser($user)
    {
        return ($user->hasRole(['Super Admin', 'Admin', 'Senior Business Partner', 'Business Partner', 'Customer','Runner']));
        // return true;
    }
    ...
    public function handle($request, Closure $next)
    {
        ...
        if (! $this->checkAuthUser(backpack_user())) {
